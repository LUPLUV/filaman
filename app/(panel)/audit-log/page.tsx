                ...
                <div>
                    ...
                    <Card className="p-2 w-full flex flex-row justify-between mt-1">
                        <div className="flex gap-1">
                            <Button disabled={currentPage <= 1} onClick={firstPage} size="icon" variant="outline"><StepBack /></Button>
                            <Button disabled={currentPage <= 1} onClick={previousPage} size="icon" variant="outline"><ChevronLeft /></Button>
                        </div>
                        ...
                        <div className="flex gap-1">
                            <Button disabled={currentPage >= Math.ceil(auditLogs.length / resultsPerPage)} onClick={nextPage} size="icon" variant="outline"><ChevronRight /></Button>
                            <Button disabled={currentPage >= Math.ceil(auditLogs.length / resultsPerPage)} onClick={lastPage} size="icon" variant="outline"><StepForward /></Button>
                        </div>
                    </Card>
